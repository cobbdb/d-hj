...
var d=/(iPad|iPhone|iPod)/gi.test(navigator.userAgent);if(!d&&this.gapi.nativeAvailable){var e=b.timeScope||0;Cocoon.callNative(this.gapi.nativeExtensionName,"showLeaderboard",[c,e,a],!0)}else{if(!this._leaderboardsTemplate)throw"Please, provide a html template for leaderboards with the setTemplates method";var f=new Cocoon.Widget.WebDialog,h=!1;f.show(this._leaderboardsTemplate,function(b){f.closed=!0,!h&&a&&a(b)});var i=b.friends?"SOCIAL":"PUBLIC",j="ALL_TIME";b.timeScope===Cocoon.Social.TimeScope.WEEK?j="WEEKLY":b.timeScope===Cocoon.Social.TimeScope.TODAY&&(j="DAILY"),this.gapi.client.request({path:this.gapi.gamesAPI+"/leaderboards/"+c+"/window/"+i,method:"GET",params:{timeSpan:j},callback:function(b){if(!f.closed){if(b.error)return void(a&&(h=!0,a(b.error),f.close()));var d=[],e=[];b&&b.items&&(e=b.items.slice(0)),b&&b.playerScore&&e.push(b.playerScore);for(var i=0;i<e.length;++i){var j=e[i],k=g(j,c);k.imageURL+="?sz=50",k.position=j.scoreRank||i+1,k.me=!1,d.push(k)}var l="addScores("+JSON.stringify(d)+")";f.eval(l)}}})}},prepareAchievements:function(a,b){if(!this._cachedAchievements||a){var c=this;this.gapi.client.request({path:this.gapi.gamesAPI+"/achievements",callback:function(a){if(a&&!a.error){var d=[];if(a&&a.items)for(var e=0;e<a.items.length;e++)d.push(f(a.items[e]));c.setCachedAchievements(d),b(d,null)}else b([],a?a.error:null)}})}else b(this._cachedAchievements,null)},requestAllAchievements:function(a){this.prepareAchievements(!0,a)},requestAchievements:function(a,b){var c=this;this.prepareAchievements(!1,function(d,e){if(e)return void a([],e);var f=b||"me";c.gapi.client.request({path:c.gapi.gamesAPI+"/players/"+f+"/achievements",params:{state:"UNLOCKED"},callback:function(b){if(b&&!b.error){var d=[];if(b.items)for(var e=0;e<b.items.length;e++){var f=c.findAchievement(b.items[e].id);f&&d.push(f)}a(d,null)}else a([],b?b.error:null)}})})},submitAchievement:function(a,b){if(null===a||"undefined"==typeof a)throw"No achievementID specified";var c=this.translateAchievementID(a);if(this.gapi.nativeAvailable){var d=!!this.gapi.settings.showAchievementNotifications;Cocoon.callNative(this.gapi.nativeExtensionName,"unlockAchievement",[c,d,b],!0)}else this.gapi.client.request({path:this.gapi.gamesAPI+"/achievements/"+c+"/unlock",method:"POST",callback:function(a){b&&b(a?a.error:null)}})},resetAchievements:function(a){this.gapi.client.request({path:"/games/v1management/achievements/reset",method:"POST",callback:function(b){a&&a(b?b.error:null)}})},showAchievements:function(a){var b=/(iPad|iPhone|iPod)/gi.test(navigator.userAgent);!b&&this.gapi.nativeAvailable?Cocoon.callNative(this.gapi.nativeExtensionName,"showAchievements",[a],!0):Cocoon.Social.SocialGamingServiceGooglePlayGames.superclass.showAchievements.call(this)}},Cocoon.extend(Cocoon.Social.SocialGamingServiceGooglePlayGames,Cocoon.Social.SocialGamingService),a}),Cocoon.define("Cocoon.Social",function(a){function b(a){return new Cocoon.Social.User(a.playerID,a.alias)}function c(a){return new Cocoon.Social.GameCenter.Achievement(a.identifier,a.title,a.achievedDescription,"",a.maximumPoints)}return a.GameCenterExtension=function(){this.nativeExtensionName="IDTK_SRV_GAMECENTER",this.extensionName="Social.GameCenter",this.nativeAvailable=!!window.ext&&!!window.ext[this.nativeExtensionName];var a=this;return this.nativeAvailable&&(this.onGameCenterLoginStateChanged=new Cocoon.EventHandler(this.nativeExtensionName,this.extensionName,"onGameCenterLoginStateChanged"),this.onGameCenterLoginStateChanged.addEventListener(function(b,c){a._currentPlayer=b})),this},a.GameCenterExtension.prototype={_currentPlayer:null,getSocialInterface:function(){return this._socialService||(this._socialService=new Cocoon.Social.SocialGamingServiceGameCenter(this)),this._socialService},getMultiplayerInterface:function(){return Cocoon.Multiplayer.GameCenter},isLoggedIn:function(){return this._currentPlayer&&this._currentPlayer.isAuthenticated},login:function(a){var b=this;if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"login",[function(c,d){b._currentPlayer=c,a&&a(c,d)}],!0)},getLocalPlayer:function(){if(this._currentPlayer)return this._currentPlayer;if(this.nativeAvailable)return this._currentPlayer=Cocoon.callNative(this.nativeExtensionName,"getLocalPlayer",[]),this._currentPlayer;throw"Game Center not available"},loadPlayers:function(a,b){if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"loadPlayers",[a,b],!0)},loadFriends:function(a){if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"loadFriends",[a],!0)},loadAchievements:function(a){if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"loadAchievements",[a],!0)},loadAchievementDescriptions:function(a){if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"loadAchievementDescriptions",[a],!0)},loadScores:function(a,b){if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"loadScores",[b,a],!0)},submitScore:function(a,b){if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"submitScore",[a,b],!0)},submitAchievements:function(a,b){if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"submitAchievements",[a,b],!0)},resetAchievements:function(a){if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"resetAchievements",[a],!0)},showAchievements:function(a){if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"showAchievements",[a],!0)},showLeaderboards:function(a,b){if(!this.nativeAvailable)throw"Game Center not available";Cocoon.callNative(this.nativeExtensionName,"showLeaderboards",[b,a],!0)}},a.GameCenter=new a.GameCenterExtension,a.GameCenter.Player=function(){this.playerID="",this.alias="",this.isFriend=!1},a.GameCenter.LocalPlayer=function(){this.playerID="",this.alias="",this.isAuthenticated=!1},a.GameCenter.Achievement=function(a,b){this.identifier=a,this.percentComplete=b,this.lastReportedDate=0},a.GameCenter.AchievementDescription=function(){this.identifier="",this.title="",this.achievedDescription="",this.unachievedDescription="",this.maximumPoints=0},a.GameCenter.Score=function(a,b,c,d,e,f){return this.userID=a,this.score=b||0,this.userName=c,this.imageURL=d,this.leaderboardID=e,this.rank=f.rank,this.originalScoreObject=f,this},a.GameCenter.Leaderboard=function(a,b,c,d,e,f){this.category=a,this.playerIDs=b,this.timeScope=c,this.playerScope=d,this.rangeStart=e,this.rangeLength=f,this.scores=[],this.localPlayerScore=[],this.localizedTitle=localizedTitle},a.GameCenter.TimeScope={TODAY:0,WEEK:1,ALL_TIME:2},a.GameCenter.PlayerScope={GLOBAL:0,FRIENDS:1},a.SocialGamingServiceGameCenter=function(a){Cocoon.Social.SocialGamingServiceGameCenter.superclass.constructor.call(this),this.gc=a;var b=this;return this.gc.onGameCenterLoginStateChanged.addEventListener(function(a,c){b.onLoginStatusChanged.notifyEventListeners(a.isAuthenticated,c)}),this},a.SocialGamingServiceGameCenter.prototype={_cachedAchievements:null,isLoggedIn:function(){return this.gc.isLoggedIn()},login:function(a){this.gc.login(function(b,c){a&&a(b.isAuthenticated,c)})},logout:function(a){a&&a({message:"User has to logout from the Game Center APP"})},getLoggedInUser:function(){return b(this.gc._currentPlayer?this.gc._currentPlayer:this.gc.getLocalPlayer())},requestUser:function(a,c){if(c)this.gc.loadPlayers([c],function(c,d){var e=c&&c.length?b(c[0]):null;a(e,d)});else{var d=this;setTimeout(function(){a(d.getLoggedInUser())})}},requestFriends:function(a,c){this.gc.loadFriends(function(c,d){var e=[];if(c&&c.length)for(var f=0;f<c.length;++f)e.push(b(c[f]));a(e,d)})},requestScore:function(a,b){var c={},d=b||{};d.leaderboardID&&(c.category=d.leaderboardID),c.playerIDs=[d.userID||this.getLoggedInUser().userID],this.gc.loadScores(function(b,c){var e=null;d.userID&&b&&b.scores&&b.scores.length?e=b.scores[0]:b&&b.localPlayerScore&&(e=b.localPlayerScore);var f=e?new Cocoon.Social.GameCenter.Score(e.playerID,e.value,"","",e.category,e):null;a(f,c)},c)},submitScore:function(a,b,c){var d=c||{};this.gc.submitScore({value:a,category:d.leaderboardID||""},function(a){b&&b(a)})},showLeaderboard:function(a,b){var c=b||{};this.gc.showLeaderboards(function(b){a&&a(b)},{category:c.leaderboardID||""})},prepareAchievements:function(a,b){if(!this._cachedAchievements||a){var d=this;this.gc.loadAchievementDescriptions(function(a,e){if(e)b([],e);else{var f=[];if(a&&a.length)for(var g=0;g<a.length;g++)f.push(c(a[g]));d.setCachedAchievements(f),b(f,null)}})}else b(this._cachedAchievements,null)},requestAllAchievements:function(a){this.prepareAchievements(!0,a)},requestAchievements:function(a,b){var c=this;this.prepareAchievements(!1,function(b,d){return d?void a([],d):void c.gc.loadAchievements(function(b,d){if(d)a([],b.error);else{var e=[];if(b&&b.length)for(var f=0;f<b.length;f++){var g=c.findAchievement(b[f].identifier);g&&e.push(g)}a(e,null)}})})},submitAchievement:function(a,b){if(null===a||"undefined"==typeof a)throw"No achievementID specified";var c=this.translateAchievementID(a);this.gc.submitAchievements([{identifier:c,percentComplete:100}],b)},resetAchievements:function(a){this.gc.resetAchievements(a)},showAchievements:function(a){this.gc.showAchievements(function(b){a&&a(b)})}},Cocoon.extend(a.SocialGamingServiceGameCenter,a.SocialGamingService),a}),Cocoon.define("Cocoon.Social",function(a){function b(a){return 0===a?"connected":1===a?"not_authorized":"unknown"}function c(a,c){var d=null;return 0===a.state&&(d={accessToken:a.accessToken,expirationDate:a.expirationDate,userID:a.user?a.userID:null,permissions:a.permissions,user:a.user}),{status:b(a.state),authResponse:d,error:c}}function d(a){return new Cocoon.Social.User(a.id,a.username?a.username:a.first_name+" "+a.last_name)}function e(a){return{link:a.linkURL,description:a.message,name:a.linkText,caption:a.linkCaption,picture:a.mediaURL}}function f(a,b){var c=new Cocoon.Social.Score(a.user.id,a.score,a.user.name);return b&&(c.leaderboardID=b.leaderboardID),c.imageURL="https://graph.facebook.com/"+a.user.id+"/picture",c}function g(a){var b=new Cocoon.Social.Achievement(a.id,a.title,a.description,a.image[0].url,a.data.points);return b.fbAchievementData=a,b}if(a.FacebookExtension=function(){this.nativeExtensionName="IDTK_SRV_FACEBOOK",this.extensionName="Social.Facebook",this.nativeAvailable=!!window.ext&&!!window.ext[this.nativeExtensionName],this.Event=new Cocoon.Social.FacebookEvent(this.nativeAvailable);var a=this;return this.nativeAvailable&&(this.onFacebookSessionStateChanged=new Cocoon.EventHandler(this.nativeExtensionName,this.extensionName,"onFacebookSessionStateChanged"),Cocoon.Social.Facebook=this,this.onFacebookSessionStateChanged.addEventListener(function(b,d){var e=c(b,d);0==b.state&&a.Event.notify("auth.login",e),a.Event.notify("auth.authResponseChange",e),a.Event.notify("auth.statusChange",e)})),this},a.FacebookExtension.prototype={_currentSession:null,_appId:null,_socialService:null,init:function(a){if(!a||!a.appId)throw"appId must be specified!";this._appId=a.appId,this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"init",[a],!0):FB.init(a);var b=this;this.Event.subscribe("auth.authResponseChange",function(a){b._currentSession=a,a.authResponse&&!a.authResponse.user&&b.api("me?fields=username",function(a){b._currentSession.authResponse.user=a})})},getSocialInterface:function(){if(!this._appId)throw"You must call init() before getting the Social Interface";return this._socialService||(this._socialService=new Cocoon.Social.SocialGamingServiceFacebook(this)),this._socialService},login:function(a,b){var d=this;this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"login",[b,function(b,e){d._currentSession=c(b,e),a&&a(d._currentSession)}],!0):FB.login(function(b){d._currentSession=b,a&&a(b)},b)},logout:function(a){this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"logout",[function(b,d){a&&a(c(b,d))}],!0):FB.logout(function(b){a&&a(b)})},getAuthResponse:function(){if(this.nativeAvailable){var a=Cocoon.callNative(this.nativeExtensionName,"getFacebookSession",[]);return c(a)}return FB.getAuthResponse()},getLoginStatus:function(a,b){if(this.nativeAvailable){var d=this;setTimeout(function(){var b=Cocoon.callNative(d.nativeExtensionName,"getFacebookSession",[]);a&&a(c(b))},50)}else FB.getLoginStatus(a,b)},api:function(a,b,c,d){if(this.nativeAvailable){var e=arguments[0],f=arguments.length>3?arguments[1]:"GET",g=null;3==arguments.length&&(g=arguments[1]),4==arguments.length&&(g=arguments[2]);var h=arguments.length>1?arguments[arguments.length-1]:function(){};return Cocoon.callNative(this.nativeExtensionName,"api",[e,f,g,h],!0)}FB.api(a,b,c,d)},ui:function(a,b){if(this.nativeAvailable){var a=arguments[0],c=arguments.length>1?arguments[1]:function(){};return Cocoon.callNative(this.nativeExtensionName,"ui",[a,c],!0)}navigator.isCocoonJS||FB.ui(a,b)},requestAdditionalPermissions:function(a,b,d){if(this.nativeAvailable){var e=b.split(",");Cocoon.callNative(this.nativeExtensionName,"requestAdditionalPermissions",[a,e,function(a,b){d&&d(c(a,b))}],!0)}else FB.login(d,{scope:b})},getPermissions:function(a){this.api("me/permissions",function(b){a(b.data&&b.data[0]?b.data[0]:{})})},showShareDialog:function(a,b){this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"showShareDialog",[a,b],!0):(a.method="feed",FB.ui(a,b))},uploadPhoto:function(a,b){this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"uploadPhoto",[a,b],!0):b({error:{message:"Not implemented"}})},showFriendPicker:function(a){this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"showFriendPicker",[a],!0):a({error:{message:"Not implemented"}})}},a.FacebookEvent=function(a){return this.nativeAvailable=a,this},a.FacebookEvent.prototype={subscribe:function(a,b){if(this.nativeAvailable){var c=a+"listeners";this[c]=this[c]||[],this[c].push(b)}else navigator.isCocoonJS||FB.Event.subscribe(a,b)},unsubscribe:function(a,b){if(this.nativeAvailable){var c=a+"listeners",d=this[c];if(d){var e=d.indexOf(b);-1!==e&&d.splice(e,1)}}else navigator.isCocoonJS||FB.Event.unsubscribe(a,b)},notify:function(a,b){var c=a+"listeners",d=this[c];if(d)for(var e=0;e<d.length;++e)d[e](b)}},a.Facebook=new a.FacebookExtension,a.SocialGamingServiceFacebook=function(a){Cocoon.Social.SocialGamingServiceFacebook.superclass.constructor.call(this),this.fb=a;var b=this;return this.fb.Event.subscribe("auth.authResponseChange",function(a){b.onLoginStatusChanged.notifyEventListeners("connected"==a.status,a.error)}),this},a.SocialGamingServiceFacebook.prototype={currentPermissions:null,isLoggedIn:function(){return this.fb._currentSession&&"connected"===this.fb._currentSession.status},login:function(a){var b=this;this.fb.login(function(c){a&&a(b.isLoggedIn(),c.error)})},logout:function(a){this.fb.logout(function(b){a&&a(b.error)})},getLoggedInUser:function(){var a=this.fb._currentSession?this.fb._currentSession.authResponse:null;return a&&a.user?d(a.user):a&&a.userID?new Cocoon.Social.Facebook.User(a.userID,"Loading..."):null},hasPublishPermissions:function(a){this.fb.getPermissions(function(b,c){a(b.publish_actions,c)})},requestPublishPermissions:function(a){var b=this;this.fb.requestAdditionalPermissions("publish","publish_actions",function(c){c.error?a(!1,error):b.hasPublishPermissions(function(b,c){a(b,c)})})},requestUser:function(a,b){var c=b||"me";this.fb.api(c,function(b){var c=b.error?null:d(b);a(c,b.error)})},requestUserImage:function(a,b,c){!b&&this.isLoggedIn()&&(b=this.fb._currentSession.authResponse.userID);var d="small";c===Cocoon.Social.ImageSize.THUMB?d="square":c===Cocoon.Social.ImageSize.MEDIUM?d="normal":c===Cocoon.Social.ImageSize.LARGE&&(d="large");var e="https://graph.facebook.com/"+b+"/picture?type="+d;a(e)},requestFriends:function(a,b){var c=(b||"me")+"/friends";this.fb.api(c,function(b){var c=[];if(!b.error)for(var e=0;e<b.data.length;e++)c.push(d(b.data[e]));a(c,b.error)})},preparePublishAction:function(a){if(this.currentPermissions)this.currentPermissions.publish_actions?a(!0):(this.currentPermissions=null,this.fb.requestAdditionalPermissions("publish","publish_actions",function(b){a(b.error?!1:!0)}));else{var b=this;this.fb.getPermissions(function(c){b.currentPermissions=c,c&&b.preparePublishAction(a)})}},publishMessage:function(a,b){this.preparePublishAction(function(c){if(c){var d=e(a),f="me/feed";this.fb.api(f,d,function(a){b&&b(a.error)})}else b&&b({message:"No publish_actions permission granted"})})},publishMessageWithDialog:function(a,b){this.fb.showShareDialog(e(a),function(a){b&&b(a.error)})},requestScore:function(a,b){var c=(b&&b.userID?b.userID:"me")+"/scores";this.fb.api(c,function(b){if(b.error)a(null,b.error);else if(b.data&&b.data.length>0){var c=f(b.data[0]);a(c,null)}else a(null,null)})},submitScore:function(a,b,c){var d=this;this.preparePublishAction(function(e){e?d.requestScore(function(e,f){if(f)return void(b&&b(f));var g=e?e.score:0;if(g>=a)return void(b&&b(null));var h="/"+(c&&c.userID?c.userID:"me")+"/scores";d.fb.api(h,"POST",{score:a},function(a){b&&b(a.error)})},c):b&&b({message:"No publish_actions permission granted"})})},showLeaderboard:function(a,b){if(!this._leaderboardsTemplate)throw"Please, provide a html template for leaderboards with the setTemplates method";var c=new Cocoon.Widget.WebDialog,d=!1;c.show(this._leaderboardsTemplate,function(b){c.closed=!0,!d&&a&&a(b)});var e=this;this.fb.api(e.fb._appId+"/scores",function(b){if(!c.closed){if(b.error)return void(a&&(d=!0,a(b.error),c.close()));var g=[];if(b.data&&b.data.length)for(var h=0;h<b.data.length;++h){var i=f(b.data[h]);i.position=h,i.imageURL="https://graph.facebook.com/"+i.userID+"/picture",i.me=i.userID===e.fb._currentSession.authResponse.userID,g.push(i)}var j="addScores("+JSON.stringify(g)+")";c.eval(j)}})},prepareAchievements:function(a,b){if(!this._cachedAchievements||a){var c=this;this.fb.api(this.fb._appId+"/achievements",function(a){if(a.error)b([],a.error);else{var d=[];if(a.data)for(var e=0;e<a.data.length;e++)d.push(g(a.data[e]));c.setCachedAchievements(d),b(d,null)}})}else b(this._cachedAchievements,null)},requestAllAchievements:function(a){this.prepareAchievements(!0,a)},requestAchievements:function(a,b){var c=this;this.prepareAchievements(!1,function(d,e){if(e)return void a([],e);var f=(b||"me")+"/achievements";c.fb.api(f,function(b){if(b.error)a([],b.error);else{var d=[];if(b.data)for(var e=0;e<b.data.length;e++){var f=c.findAchievement((b.data[e].achievement||b.data[e].data.achievement).id);f&&d.push(f)}a(d,null)}})})},submitAchievement:function(a,b){if(null===a||"undefined"==typeof a)throw"No achievementID specified";var c=this.translateAchievementID(a),d=this;this.preparePublishAction(function(a){a?d.fb.api("me/achievements","POST",{achievement:c},function(a){b&&b(a.error)}):b&&b({message:"No publish_actions permission granted"})})},resetAchievements:function(a){var b=this;this.preparePublishAction(function(c){c?b.requestAchievements(function(c,d){if(d)return void(a&&a(d));for(var e=null,f=c.length,g=0;g<c.length;++g)b.fb.api("me/achievements","DELETE",{achievement:c[g].fbAchievementData.url},function(b){b.error&&(e=b.error),f--,0==f&&a&&a(e)})}):a&&a({message:"No publish_actions permission granted"})})},showAchievements:function(a){if(!this._achievementsTemplate)throw"Please, provide a html template for achievements with the setTemplates method";var b=new Cocoon.Widget.WebDialog,c=!1;b.show(this._achievementsTemplate,function(d){b.closed=!0,!c&&a&&a(d)});var d=this;this.requestAchievements(function(e,f){if(!b.closed){if(f)return c=!0,void(a&&a(f));var g=[];if(d._cachedAchievements)for(var h=0;h<d._cachedAchievements.length;++h){var i=d._cachedAchievements[h];if(g.push(i),e&&e.length)for(var j=0;j<e.length;++j)if(e[j].achievementID===i.achievementID){i.achieved=!0;break}}var k="addAchievements("+JSON.stringify(g)+");";b.eval(k)}})}},Cocoon.extend(a.SocialGamingServiceFacebook,a.SocialGamingService),!(navigator.isCocoonJS||"undefined"!=typeof module&&module.exports)){var h=document.getElementsByTagName("script")[0],i=document.createElement("script"),j=location.protocol?location.protocol:"http:";i.src=j+"//connect.facebook.net/en_US/all.js",h.parentNode.insertBefore(i,h)}return a}),Cocoon.define("Cocoon.Multiplayer",function(a){return a.MultiplayerService=function(a,b){this.nativeExtensionName=a,this.extensionName=b,this.nativeAvailable=!!window.ext&&!!window.ext[this.nativeExtensionName];var c=this;this.onInvitationReceived=new Cocoon.EventHandler(this.nativeExtensionName,this.extensionName,"onInvitationReceived"),this.onInvitationLoaded=new Cocoon.EventHandler(this.nativeExtensionName,this.extensionName,"onInvitationLoaded",function(a,b){var d=b[0],e=b[1];d&&!e?(c.currentMatch=new Cocoon.Multiplayer.Match(c.nativeExtensionName,c.extensionName,d),a(c.currentMatch,null)):a(null,e)});var d=new Cocoon.Signal.createSignal;return d.register("invitation",{received:this.onInvitationReceived,loaded:this.onInvitationLoaded}),this.on=d.expose(),this},a.MultiplayerService.prototype={currentMatch:null,findMatch:function(a,b){var c=this;this.nativeAvailable&&Cocoon.callNative(this.nativeExtensionName,"findMatch",[a,function(a,d){a&&!d?(c.currentMatch=new Cocoon.Multiplayer.Match(c.nativeExtensionName,c.extensionName,a),b(c.currentMatch,null)):b(null,d)}],!0)},findAutoMatch:function(a,b){var c=this;this.nativeAvailable&&Cocoon.callNative(this.nativeExtensionName,"findAutoMatch",[a,function(a,d){a&&!d?(c.currentMatch=new Cocoon.Multiplayer.Match(c.nativeExtensionName,c.extensionName,a),b(c.currentMatch,null)):b(null,d)}],!0)},cancelAutoMatch:function(){this.nativeAvailable&&Cocoon.callNative(this.nativeExtensionName,"cancelAutoMatch",[],!0)},addPlayersToMatch:function(a,b,c){this.nativeAvailable&&Cocoon.callNative(this.nativeExtensionName,"addPlayersToMatch",[a,b.matchID,c],!0)},getMatch:function(){return this.currentMatch}},a.Match=function(a,b,c){if("string"!=typeof a)throw"The given native extension name '"+a+"' is not a string.";if("string"!=typeof b)throw"The given extension name '"+a+"' is not a string.";this.nativeExtensionName=a,this.extensionName=b,this.nativeAvailable=Cocoon.nativeAvailable&&"undefined"!=typeof window.ext[a],this.matchID=c;var d=this;this.onMatchDataReceived=new Cocoon.EventHandler(this.nativeExtensionName,this.extensionName,"onMatchDataReceived",function(a,b){d.matchID===b[0]&&a(d,b[1],b[2])}),this.onMatchStateChanged=new Cocoon.EventHandler(this.nativeExtensionName,this.extensionName,"onMatchStateChanged",function(a,b){d.matchID===b[0]&&a(d,b[1],b[2])}),this.onMatchConnectionWithPlayerFailed=new Cocoon.EventHandler(this.nativeExtensionName,this.extensionName,"onMatchConnectionWithPlayerFailed",function(a,b){d.matchID===b[0]&&a(d,b[1],b[2])}),this.onMatchFailed=new Cocoon.EventHandler(this.nativeExtensionName,this.extensionName,"onMatchFailed",function(a,b){d.matchID===b[0]&&a(d,b[1])});var e=new Cocoon.Signal.createSignal;e.register("match",{dataReceived:this.onMatchDataReceived,stateChanged:this.onMatchStateChanged,connectionWithPlayerFailed:this.onMatchConnectionWithPlayerFailed,failed:this.onMatchFailed}),this.on=e.expose()},a.Match.prototype={start:function(){this.nativeAvailable&&Cocoon.callNative(this.nativeExtensionName,"startMatch",[this.matchID],!0)},sendDataToAllPlayers:function(a,b){return this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"sendDataToAllPlayers",[this.matchID,a,b]):void 0},sendData:function(a,b,c){return this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"sendData",[this.matchID,a,b,c]):void 0},disconnect:function(){return this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"disconnect",[this.matchID],!0):void 0},requestPlayersInfo:function(a){return this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"requestPlayersInfo",[this.matchID,a],!0):void 0},getExpectedPlayerCount:function(){return this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"getExpectedPlayerCount",[this.matchID]):void 0},getPlayerIDs:function(){return this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"getPlayerIDs",[this.matchID]):void 0},getLocalPlayerID:function(){return this.nativeAvailable?Cocoon.callNative(this.nativeExtensionName,"getLocalPlayerID",[this.matchID]):""}},a.SendDataMode={RELIABLE:0,UNRELIABLE:1},a.ConnectionState={UNKNOWN:0,CONNECTED:1,DISCONNECTED:2},a.PlayerInfo=function(a,b){this.userID=a,this.userName=b},a.MatchRequest=function(a,b,c,d,e){return this.minPlayers=a,this.maxPlayers=b,this.playersToInvite=c,this.playerGroup=d,this.playerAttributes=e,this},a}),Cocoon.define("Cocoon.Multiplayer",function(a){var b=[],c=0,d=[],e=0;a.LoopbackService=function(){Cocoon.Multiplayer.LoopbackService.superclass.constructor.call(this,"dummy","dummy"),b.push(this),this.playerID=""+c,c++},a.LoopbackService.prototype={findMatch:function(a,b){this.findMatchCallback=b;for(var c=!1,e=0;e<d.length;++e)if(d[e]===this){c=!0;break}if(c||d.push(this),d.length>=a.minPlayers){for(var g=[],e=0;e<d.length;++e)g.push(d[e].getPlayerID());for(var e=0;e<d.length;++e){var h=new f(d[e]);h.playerIDs=g.slice(),d[e].currentMatch=h,d[e].findMatchCallback(h,null)}d=[]}},findAutoMatch:function(a,b){this.findMatch(a,b)},cancelAutoMatch:function(){},addPlayersToMatch:function(a,b,c){c({message:"Not implemmented"})},getPlayerID:function(){return this.playerID},getMatch:function(){return this.currentMatch}},Cocoon.extend(a.LoopbackService,a.MultiplayerService);var f=function(a){e++,f.superclass.constructor.call(this,"","",e),this.started=!1,this.disconnected=!1,this.pendingData=[],this.service=a};return f.prototype={start:function(){var a=this;setTimeout(function(){a.started=!0;for(var b=0;b<a.pendingData.length;++b)a.onMatchDataReceived.notifyEventListeners(a.matchID,a.pendingData[b].data,a.pendingData[b].player)},0)},sendDataToAllPlayers:function(a,b){this.sendData(a,this.playerIDs,b)},sendData:function(a,c,d){var e=this;setTimeout(function(){for(var d=0;d<b.length;++d){for(var f=null,g=0;g<c.length;++g)c[g]===b[d].getPlayerID()&&(f=b[d]);f&&f.getMatch().notifyDataReceived(a,e.service.getPlayerID())}},0)},disconnect:function(){this.disconnected=!0;for(var a=0;a<this.playerIDs.length;++a)for(var c=this.playerIDs[a],d=0;d<b.length;++d)if(b[d].getPlayerID()===c){var e=b[a].getMatch();e.disconnected||e.onMatchStateChanged.notifyEventListeners(e,this.service.getPlayerID(),Cocoon.Multiplayer.ConnectionState.DISCONNECTED)}},requestPlayersInfo:function(a){var b=this;setTimeout(function(){for(var c=[],d=0;d<b.playerIDs.length;++d)c[d]={userID:b.playerIDs[d],userName:"Player"+b.playerIDs[d]};a(c)},1)},getExpectedPlayerCount:function(){return 0},getPlayerIDs:function(){return this.playerIDs},getLocalPlayerID:function(){return this.service.playerID},notifyDataReceived:function(a,b){this.started?this.onMatchDataReceived.notifyEventListeners(this.matchID,a,b):this.pendingData.push({data:a,player:b})}},Cocoon.extend(f,Cocoon.Multiplayer.Match),a}),Cocoon.define("Cocoon.Multiplayer",function(a){return a.GooglePlayGames=new Cocoon.Multiplayer.MultiplayerService("IDTK_SRV_MULTIPLAYER_GPG","Multiplayer.GooglePlayGames"),a}),Cocoon.define("Cocoon.Multiplayer",function(a){return a.GameCenter=new Cocoon.Multiplayer.MultiplayerService("IDTK_SRV_MULTIPLAYER_GAMECENTER","Multiplayer.GameCenter"),a}),function a(b,c,d){function e(g,h){if(!c[g]){if(!b[g]){var i="function"==typeof require&&require;if(!h&&i)return i(g,!0);if(f)return f(g,!0);var j=new Error("Cannot find module '"+g+"'");throw j.code="MODULE_NOT_FOUND",j}var k=c[g]={exports:{}};b[g][0].call(k.exports,function(a){var c=b[g][1][a];return e(c?c:a)},k,k.exports,a,b,c,d)}return c[g].exports}for(var f="function"==typeof require&&require,g=0;g<d.length;g++)e(d[g]);return e}({1:[function(a,b,c){b.exports={img:["buttons/care.down.png","buttons/care.png","buttons/down.png","buttons/gear.down.png","buttons/gear.png","buttons/minus.png","buttons/plus.null.png","buttons/plus.png","buttons/start-race.down.png","buttons/start-race.png","buttons/train.down.png","buttons/train.png","buttons/up.png","explosion.png","haybale.png","horse.png","icons/train-pips.png","jockey.png","lane.png","lost.png","mudpit.png","sick-horse.png","slider-knob.png","slider-lane.png","slider.png","win.png"],sound:[],font:["8-bit-wonder.ttf"]}},{}],2:[function(a,b,c){b.exports=function(){throw Error("[BaseClass] Abstract method was called without definition.")}},{}],3:[function(a,b,c){b.exports=function(a,b,c,d){return function(){var e,f=b.base;return b.base=c,b.self=d,e=d[a].apply(b,arguments),b.base=f,e}}},{}],4:[function(a,b,c){(function(c){function d(a){return a=a||{},a.extend=function(b){var d,h={base:a.base};b=b||{};for(d in a)a[d]instanceof c.Function&&(h[d]=f(a[d],a));for(d in b)b[d]instanceof c.Function?a[d]=e(d,a,h,b):a[d]=b[d];return a.base=h,"_create"in b?a._create():a._create=g,a},a.implement=function(){var b,c=arguments.length;for(b=0;c>b;b+=1)arguments[b](a);return a},"_create"in a?a._create.call(a):a._create=g,a}var e=a("./base-swap.js"),f=a("./bind.js"),g=a("./stub.js");d.Abstract=a("./abstract.js"),d.Stub=g,d.Interface=a("./interface.js"),b.exports=d}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./abstract.js":2,"./base-swap.js":3,"./bind.js":5,"./interface.js":6,"./stub.js":7}],5:[function(a,b,c){b.exports=function(a,b){return function(){return a.apply(b,arguments)}}},{}],6:[function(a,b,c){b.exports=function(a){return function(b){var c;for(c in a)b[c]=a[c];return b}}},{}],7:[function(a,b,c){b.exports=function(){}},{}],8:[function(a,b,c){b.exports=function(){var a,b=arguments[0],c=arguments.length;for(a=1;c>a;a+=1)b=b.replace(/%s/,arguments[a]);return b}},{}],9:[function(a,b,c){(function(c){var d=a("./item.js"),e=a("./geom/dimension.js"),f=a("./geom/point.js"),g=a("./assets/pipeline.js");b.exports=function(a,b){var h,i,j=g.get.image(a),k=0,l=!1,m=1;return b=b||{},b.kind=b.kind||"$:animation-strip",b.sinusoid=b.sinusoid||!1,b.start=b.start||f(),b.frames=b.frames||1,b.size=b.size||e(j.width/b.frames,j.height),i=f(b.size.width*b.start.x,b.size.height*b.start.y),d(b).extend({size:b.size,frame:0,speed:b.speed||0,start:function(){h=c.Date.now(),l=this.speed>0},pause:function(){l=!1},stop:function(){k=0,this.frame=0,m=1,l=!1},update:function(){var a=1/this.speed*1e3,b=c.Date.now(),d=b-h;k+=d,k>=a&&(k=0,this.nextFrame()),h=b},nextFrame:function(){return this.frame+=m,b.sinusoid?this.frame%(b.frames-1)===0&&(m*=-1):this.frame%=b.frames,this.frame},draw:function(a,b){var c=this.frame*this.size.width;a.drawImage(j,i.x+c,i.y,this.size.width,this.size.height,0,0,b.width||this.size.width,b.height||this.size.height)}})}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./assets/pipeline.js":13,"./geom/dimension.js":23,"./geom/point.js":24,"./item.js":35}],10:[function(a,b,c){(function(a){b.exports=function(b,c){var d=a.document.createElement("audio"),e=d.play;return d.onloadeddata=c,d.loop=!1,d.volume=1,d.play=function(a){a&&(this.currentTime=0),e.call(this)},d.stop=function(){this.pause(),this.currentTime=0},d.onplay=function(){},d.onplaying=function(){},d.onended=function(){},d.src="assets/sound/"+b,d}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],11:[function(a,b,c){(function(c){var d=a("curb");b.exports=function(a,b){var e=c.document.createElement("style");return e.innerHTML=d("@font-face{%s}",["font-family:"+a,"font-style:"+(b.style||"normal"),"font-weight:"+(b.weight||400),"src:url(assets/font/"+b.src+")"].join(";")),c.document.body.appendChild(e),
!0}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{curb:8}],12:[function(a,b,c){b.exports=function(a,b){var c=new Image;return c.onload=b,c.src="assets/img/"+a,c}},{}],13:[function(a,b,c){var d=(a("../util/object.js"),a("./image.js")),e=a("./audio.js"),f=a("./font.js"),g=(a("../game.js"),a("../heartbeat.js")),h=a("../../../../assets/directory.json"),i=!1,j=0,k=function(){},l=function(){j-=1,0===j&&k()},m={image:{},sound:{},font:{}};b.exports={load:function(a){a=a||function(){},i||(i=!0,k=function(){a(),g.run()},j+=h.img.length,j+=h.sound.length,j?(h.img.forEach(this.add.image),h.sound.forEach(this.add.sound)):k())},get ready(){return 0===j},get:{image:function(a){return m.image[a]},sound:function(a){return m.sound[a]}},add:{image:function(a){return a in m.image||(m.image[a]=d(a,l)),m.image[a]},sound:function(a){return a in m.sound||(m.sound[a]=e(a,l)),m.sound[a]},font:function(a,b){return a in m.font||(m.font[a]=f(a,b)),!0}}}},{"../../../../assets/directory.json":1,"../game.js":22,"../heartbeat.js":30,"../util/object.js":52,"./audio.js":10,"./font.js":11,"./image.js":12}],14:[function(a,b,c){var d=a("./collidable.js"),e=a("./geom/point.js"),f=a("./geom/vector.js"),g=a("./geom/dimension.js"),h=a("./geom/rectangle.js"),i=a("./util/number.js");b.exports=function(a){var b=a.pos||e(),c=a.size||g(),j=a.scale||1,k=c.clone().multiplyFixed(j,j);return a.name=a.name||"$:clear-sprite",a.kind=a.kind||"$:clear-sprite",a.mask=a.mask||h(),a.freemask||(a.offset=a.mask.pos(),a.mask.moveFixed(b.x+a.offset.x,b.y+a.offset.y),a.mask.width||a.mask.height||a.mask.resize(k)),d(a).extend({gravity:a.gravity||0,friction:a.friction||0,pos:b,alpha:a.alpha||1,scale:function(b){return b?(j=b,k.width=c.width*j,k.height=c.height*j,k.floor(),a.freemask||this.mask.resize(k),void 0):j},size:function(b){return b?(c.set(b),k.width=c.width*j,k.height=c.height*j,k.floor(),a.freemask||this.mask.resize(k),void 0):k},rotation:a.rotation||0,rotationSpeed:a.rotationSpeed||0,speed:a.speed||f(),update:function(){this.rotationSpeed*=1-this.friction,this.rotation+=this.rotationSpeed,this.rotation%=i.PI2,this.speed.y+=this.gravity,this.speed.isZero()||(this.speed.x*=1-this.friction,this.speed.y*=1-this.friction,this.shift()),this.base.update()},draw:function(a){var b=i.sin(this.rotation),c=i.cos(this.rotation);a.globalAlpha=this.alpha,a.setTransform(c,b,-b,c,this.pos.x,this.pos.y),a.moveTo(k.width,0)},move:function(a){this.moveFixed(a.x,a.y)},moveFixed:function(b,c){this.pos.moveFixed(b,c),a.freemask||this.base.moveFixed(b,c)},shift:function(a){a=a||this.speed,this.moveFixed(this.pos.x+a.x,this.pos.y+a.y)},shiftFixed:function(a,b){var c=a||this.speed.x,d=b||this.speed.y;this.moveFixed(this.pos.x+c,this.pos.y+d)}})}},{"./collidable.js":16,"./geom/dimension.js":23,"./geom/point.js":24,"./geom/rectangle.js":26,"./geom/vector.js":28,"./util/number.js":51}],15:[function(a,b,c){var d=a("./item.js"),e=a("./util/set.js");b.exports=function(a){var b=!1;return a.name=a.name||"$:collection",a.kind=a.kind||"$:collection",d(a).extend({sorted:"sorted"in a?a.sorted:!0,set:[],map:{},add:function(a){var b,c,d;if(a){for(a=e.array(a),c=a.length,b=0;c>b;b+=1)d=a[b],d.removed=!1,this.set.push(d),this.map[d.name]=d,d.trigger("$added");this.sorted&&this.set.sort(function(a,b){return a.depth-b.depth})}return this},remove:function(a){a.removed=!0,b=!0},clear:function(){this.set.length=0,this.map={}},get:function(a){return this.map[a]},update:function(){var a,b,c=this.set.length;for(a=0;c>a;a+=1)b=this.set[a],this.updating&&b.updating&&!b.removed&&b.update()},draw:function(a){var b,c,d=this.set.length;for(b=0;d>b;b+=1)c=this.set[b],this.drawing&&c.drawing&&!c.removed&&(a.globalAlpha=1,a.resetTransform(),c.draw(a))},teardown:function(){var a,c,d=this.set.length;for(a=0;d>a;a+=1)c=this.set[a],this.updating&&c.updating&&!c.removed&&c.teardown();b&&(this.set=this.set.filter(function(a){return!a.removed}),b=!1)}})}},{"./item.js":35,"./util/set.js":54}],16:[function(a,b,c){(function(c){var d=a("./util/id-counter.js"),e=a("./geom/rectangle.js"),f=a("./geom/vector.js"),g=a("./item.js"),h=a("./io/mouse.js"),i=a("./io/canvas.js"),j=a("./util/set.js");b.exports=function(a){var b={},k={},l=!1;return a.collisions=j.array(a.collisions),a.name=a.name||"$:collidable",a.kind=a.kind||"$:collidable",g(a).extend({_create:function(){this.on("$collide#screendrag",function(){var a=this;this.dragging||(this.dragging=!0,h.on("$up",function(){a.dragging=!1}))})},id:d.nextId(),dragging:!1,mask:a.mask||e(),offset:a.offset||f(),onscreen:function(){return this.intersects(i.mask)},move:function(a){this.mask.moveFixed(a.x+this.offset.x,a.y+this.offset.y)},moveFixed:function(a,b){this.mask.moveFixed(a+this.offset.x,b+this.offset.y)},flush:function(a){var b=this.mask.bottom-a.mask.top,d=a.mask.right-this.mask.left,e=a.mask.bottom-this.mask.top,f=this.mask.right-a.mask.left,g=c.Math.min(b,d,e,f),h=this.pos.x,i=this.pos.y;g===b?i=a.mask.y-this.mask.height:g===d?h=a.mask.right:g===e?i=a.mask.bottom:h=a.mask.x-this.mask.width,this.moveFixed(h,i)},intersects:function(a){return this.mask.intersects(a)},update:function(){var b,c;if(!l)for(l=!0,c=a.collisions.length,b=0;c>b;b+=1)a.collisions[b].update(this)},teardown:function(){l=!1,k={}},addCollision:function(a){b[a]=!0,k[a]=!0},removeCollision:function(a){b[a]=!1},clearCollisions:function(){b={}},isCollidingWith:function(a){return b[a]||!1},canCollideWith:function(a){var b=this.id===a,c=k[a];return!b&&!c}})}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./geom/rectangle.js":26,"./geom/vector.js":28,"./io/canvas.js":32,"./io/mouse.js":34,"./item.js":35,"./util/id-counter.js":50,"./util/set.js":54}],17:[function(a,b,c){var d=(a("./util/object.js"),a("./item.js"));b.exports=function(a){var b=[];return a.name=a.name||"$:collision-handler",a.kind=a.kind||"$:collision-handler",d(a).extend({draw:function(a){var c,d=b.length;for(c=0;d>c;c+=1)b[c].mask.draw(a)},clearCollisions:function(){b.length=0},update:function(a){b.push(a)},handleCollisions:function(){var a,c,d,e,f,g,h,i;for(d=b.length,a=0;d>a;a+=1)for(e=b[a],c=0;d>c;c+=1)f=b[c],i=e.canCollideWith(f.id),i&&(g=e.intersects(f.mask),h=e.isCollidingWith(f.id),g?(e.addCollision(f.id),h||(e.trigger("$collide#"+f.name,f),e.trigger("$collide."+f.kind,f)),e.trigger("$colliding#"+f.name,f),e.trigger("$colliding."+f.kind,f)):(e.removeCollision(f.id),h&&(e.trigger("$separate#"+f.name,f),e.trigger("$separate."+f.kind,f)),e.trigger("$miss#"+f.name,f),e.trigger("$miss."+f.kind,f)))},teardown:function(){b.length=0}})}},{"./item.js":35,"./util/object.js":52}],18:[function(a,b,c){var d=a("./game.js"),e=a("./util/set.js"),f=(a("./heartbeat.js"),a("./assets/pipeline.js")),g=a("./util/timer.js");b.exports={Shape:a("./geom/shape.js"),Rectangle:a("./geom/rectangle.js"),Dimension:a("./geom/dimension.js"),Point:a("./geom/point.js"),Vector:a("./geom/vector.js"),Polar:a("./geom/polar.js"),FrameCounter:a("./util/frame-counter.js"),IdCounter:a("./util/id-counter.js"),timer:g,setTimeout:g.setTimeout,setInterval:g.setInterval,clear:g.clear,concat:e.concat,concatLeft:e.concatLeft,random:a("./util/random.js"),range:e.range,shuffle:e.shuffle,math:a("./util/number.js"),Mouse:a("./io/mouse.js"),Key:a("./io/keyboard.js"),canvas:a("./io/canvas.js"),loadAssets:f.load.bind(f),addFont:f.add.font,image:f.get.image,sound:f.get.audio,AnimationStrip:a("./animation-strip.js"),CollisionHandler:a("./collision-handler.js"),collisions:a("./dragon-collisions.js"),debug:d.useDebug,screen:d.screen,sprite:d.sprite,addScreens:d.addScreens,removeScreen:d.removeScreen,Eventable:a("./eventable.js"),Screen:a("./screen.js"),Collidable:a("./collidable.js"),Sprite:a("./sprite.js"),ClearSprite:a("./clear-sprite.js"),ui:{Button:a("./ui/button.js"),Label:a("./ui/label.js")},fadeable:a("./interface/fadeable.js"),particle:{Emitter:a("./particle/emitter.js"),Square:a("./particle/square.js"),Circle:a("./particle/circle.js"),Image:a("./particle/image.js")}}},{"./animation-strip.js":9,"./assets/pipeline.js":13,"./clear-sprite.js":14,"./collidable.js":16,"./collision-handler.js":17,"./dragon-collisions.js":19,"./eventable.js":21,"./game.js":22,"./geom/dimension.js":23,"./geom/point.js":24,"./geom/polar.js":25,"./geom/rectangle.js":26,"./geom/shape.js":27,"./geom/vector.js":28,"./heartbeat.js":30,"./interface/fadeable.js":31,"./io/canvas.js":32,"./io/keyboard.js":33,"./io/mouse.js":34,"./particle/circle.js":40,"./particle/emitter.js":41,"./particle/image.js":42,"./particle/square.js":43,"./screen.js":44,"./sprite.js":45,"./ui/button.js":46,"./ui/label.js":47,"./util/frame-counter.js":49,"./util/id-counter.js":50,"./util/number.js":51,"./util/random.js":53,"./util/set.js":54,"./util/timer.js":55}],19:[function(a,b,c){var d=a("./collision-handler.js");b.exports=d({name:"dragon"})},{"./collision-handler.js":17}],20:[function(a,b,c){var d=a("./collection.js"),e=a("./collidable.js"),f=a("./geom/rectangle.js"),g=(a("./geom/point.js"),a("./geom/dimension.js"),a("./io/canvas.js")),h=a("./dragon-collisions.js");b.exports=d({name:"$:masks",sorted:!1}).add([a("./mask/screentap.js"),a("./mask/screendrag.js"),a("./mask/screenhold.js"),e({name:"screenedge/top",mask:f(0,-20,g.width,20),collisions:h}),e({name:"screenedge/right",mask:f(g.width,0,20,g.height),collisions:h}),e({name:"screenedge/bottom",mask:f(0,g.height,g.width,20),collisions:h}),e({name:"screenedge/left",mask:f(-20,0,20,g.height),collisions:h})])},{"./collection.js":15,"./collidable.js":16,"./dragon-collisions.js":19,"./geom/dimension.js":23,"./geom/point.js":24,"./geom/rectangle.js":26,"./io/canvas.js":32,"./mask/screendrag.js":36,"./mask/screenhold.js":37,"./mask/screentap.js":38}],21:[function(a,b,c){var d=a("baseclassjs"),e=a("./util/set.js");b.exports=function(a){var b,c,f;a=a||{};for(f in a.on)a.on[f]=e.array(a.on[f]);b=a.on||{};for(f in a.one)a.one[f]=e.array(a.one[f]);return c=a.one||{},d({on:function(a,c){b[a]=b[a]||[],b[a].push(c)},one:function(a,b){c[a]=c[a]||[],c[a].push(b)},off:function(a){b[a].length=0,c[a].length=0},trigger:function(a,d){var e,f;if(a in b)for(f=b[a].length,e=0;f>e;e+=1)b[a][e].call(this,d);if(a in c){for(f=c[a].length,e=0;f>e;e+=1)c[a][e].call(this,d);c[a].length=0}}})}},{"./util/set.js":54,baseclassjs:4}],22:[function(a,b,c){var d=a("./util/frame-counter.js"),e=a("./collection.js"),f=a("./util/timer.js"),g=a("./io/canvas.js").ctx,h=a("./dragon-collisions.js"),i=a("./dragon-masks.js");b.exports=e({name:"$:game"}).extend({debug:!1,useDebug:function(){this.debug=!0,d.start()},update:function(){i.update(),this.base.update(),f.update(),h.handleCollisions()},draw:function(){this.base.draw(g),this.debug&&(d.draw(g),h.draw(g))},teardown:function(){h.teardown(),i.teardown(),this.base.teardown()},screen:function(a){return this.base.get(a)},addScreens:function(a){this.base.add(a)},removeScreen:function(a){var b=this.map[a];this.base.remove(b)}})},{"./collection.js":15,"./dragon-collisions.js":19,"./dragon-masks.js":20,"./io/canvas.js":32,"./util/frame-counter.js":49,"./util/timer.js":55}],23:[function(a,b,c){(function(c){var d=a("./zero.js");b.exports=function(a,e){return{width:a||0,height:e||0,clone:function(){return b.exports(this.width,this.height)},set:function(a){return this.width=a.width,this.height=a.height,this},setFixed:function(a,b){return this.width=a,this.height=b,this},equals:function(a){return this.width===a.width&&this.height===a.height},floor:function(){return this.width=c.Math.floor(this.width),this.height=c.Math.floor(this.height),this},isZero:function(){return this.equals(d)},multiply:function(a){return this.width*=a.width,this.height*=a.height,this},multiplyFixed:function(a,b){return this.width*=a,this.height*=b,this},divide:function(a){return this.width/=a.width,this.height/=a.height,this},divideFixed:function(a,b){return this.width/=a,this.height/=b,this},add:function(a){return this.width+=a.width,this.height+=a.height,this},addFixed:function(a,b){return this.width+=a,this.height+=b,this},subtract:function(a){return this.width-=a.width,this.height-=a.height,this},subtractFixed:function(a,b){return this.width-=a,this.height-=b,this}}}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./zero.js":29}],24:[function(a,b,c){(function(c){var d=a("./zero.js");b.exports=function(a,e){return{x:a||0,y:e||0,clone:function(){return b.exports(this.x,this.y)},set:function(a){return this.x=a.x,this.y=a.y,this},setFixed:function(a,b){return this.x=a,this.y=b,this},equals:function(a){return this.x===a.x&&this.y===a.y},floor:function(){return this.x=c.Math.floor(this.x),this.y=c.Math.floor(this.y),this},isZero:function(){return this.equals(d)},move:function(a){return this.x=a.x,this.y=a.y,this},moveFixed:function(a,b){return this.x=a,this.y=b,this},multiply:function(a){return this.x*=a.x,this.y*=a.y,this},multiplyFixed:function(a,b){return this.x*=a,this.y*=b,this},divide:function(a){return this.x/=a.x,this.y/=a.y,this},divideFixed:function(a,b){return this.x/=a,this.y/=b,this},add:function(a){return this.x+=a.x,this.y+=a.y,this},addFixed:function(a,b){return this.x+=a,this.y+=b,this},subtract:function(a){return this.x-=a.x,this.y-=a.y,this},subtractFixed:function(a,b){return this.x-=a,this.y-=b,this}}}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./zero.js":29}],25:[function(a,b,c){function d(a,b,c,d){var f=a.magnitude===d*b.magnitude,g=(a.theta%e.PI).toFixed(5),h=((b.theta+c)%e.PI).toFixed(5);return f&&g===h}var e=a("../util/number.js");b.exports=function(c,f){return{theta:c||0,magnitude:f||0,invert:function(){return b.exports(this.theta+e.PI,-1*this.magnitude)},clone:function(){return b.exports(this.theta,this.magnitude)},toVector:function(){var b=a("./vector.js");return b(this.magnitude*e.cos(this.theta),this.magnitude*e.sin(this.theta))},equals:function(a){return d(this,a,0,1)||d(this,a,e.PI,-1)}}}},{"../util/number.js":51,"./vector.js":28}],26:[function(a,b,c){var d=a("./point.js");a("./dimension.js");b.exports=function(a,b,c,e){return a=a||0,b=b||0,c=c||0,e=e||0,{name:"$:Rectangle",kind:"$:Shape",intersects:function(a){return this.x<a.right&&this.right>a.x&&this.y<a.bottom&&this.bottom>a.y},x:a,y:b,width:c,height:e,top:b,right:a+c,bottom:b+e,left:a,center:d(a+c/2,b+e/2),pos:function(){return d(this.x,this.y)},move:function(a){this.moveFixed(a.x,a.y)},moveFixed:function(a,b){this.x=a,this.y=b,this.top=b,this.right=a+this.width,this.bottom=b+this.height,this.left=a,this.center.x=a+this.width/2,this.center.y=b+this.height/2},shift:function(a){this.moveFixed(this.x+a.x,this.y+a.y)},shiftFixed:function(a,b){this.moveFixed(this.x+a,this.y+b)},resize:function(a){this.resizeFixed(a.width,a.height)},resizeFixed:function(a,b){this.width=a,this.height=b,this.right=this.x+a,this.bottom=this.y+b,this.center.x=this.x+a/2,this.center.y=this.y+b/2},draw:function(a){a.beginPath(),a.lineWidth=1,a.globalAlpha=.5,a.strokeStyle="#f55",a.rect(this.x,this.y,this.width,this.height),a.stroke()}}}},{"./dimension.js":23,"./point.js":24}],27:[function(a,b,c){var d=a("baseclassjs"),e=a("./point.js");b.exports=function(a){var b,c;return a=a||{},c=a.intersects||{},b=a.pos||e(),d({x:b.x,y:b.y,width:0,height:0,top:0,right:0,bottom:0,left:0,pos:function(){return e(this.x,this.y)},name:a.name,move:d.Abstract,resize:d.Abstract,intersects:function(a){return c[a.name].call(this,a)},draw:d.Stub})}},{"./point.js":24,baseclassjs:4}],28:[function(a,b,c){(function(c){var d=a("./zero.js");b.exports=function(e,f){return{x:e||0,y:f||0,magnitude:function(){return c.Math.sqrt(c.Math.pow(this.x,2)+c.Math.pow(this.y,2))},D:function(){return c.Math.pow(this.x,2)+c.Math.pow(this.y,2)},clone:function(){return b.exports(this.x,this.y)},equals:function(a){return this.x===a.x&&this.y===a.y},set:function(a){this.x=a.x,this.y=a.y},setFixed:function(a,b){this.x=a,this.y=b},isZero:function(){return this.equals(d)},toPolar:function(){var b=a("./polar.js");return b(c.Math.atan(this.y/this.x),this.magnitude)},multiply:function(a){return this.x*=a.x,this.y*=a.y,this},divide:function(a){return this.x/=a.x,this.y/=a.y,this},add:function(a){return this.x+=a.x,this.y+=a.y,this},subtract:function(a){return this.x-=a.x,this.y-=a.y,this}}}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./polar.js":25,"./zero.js":29}],29:[function(a,b,c){b.exports={x:0,y:0,right:0,left:0,top:0,bottom:0,width:0,height:0}},{}],30:[function(a,b,c){(function(c){var d=a("./game.js"),e=a("./util/frame-counter.js"),f=!1;b.exports={run:function(){function a(){d.update(),d.draw(),d.teardown(),e.countFrame(),c.requestAnimationFrame(a)}f||(f=!0,c.requestAnimationFrame(a))}}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./game.js":22,"./util/frame-counter.js":49}],31:[function(a,b,c){var d=a("baseclassjs");b.exports=d.Interface({fadeIn:function(){},fadeOut:function(){}})},{baseclassjs:4}],32:[function(a,b,c){(function(c){var d=a("../geom/rectangle.js"),e=a("../geom/point.js"),f=(a("../geom/dimension.js"),a("../util/detect-mobile.js")),g=c.document.createElement("canvas");f?(g.width=c.innerWidth,g.height=c.innerHeight):("landscape"===c.localStorage.drago?(g.width=480,g.height=320):(g.width=320,g.height=480),g.style.border="1px solid #000"),c.document.body.appendChild(g),g.mobile=f,g.ctx=g.getContext("2d"),g.ctx.resetTransform||(g.ctx.resetTransform=function(){g.ctx.setTransform(1,0,0,1,0,0)}),g.clear=function(a){g.ctx.resetTransform(),a?(g.ctx.fillStyle=a,g.ctx.fillRect(0,0,g.width,g.height)):g.ctx.clearRect(0,0,g.width,g.height)},g.mask=d(0,0,g.width,g.height),g.center=e(g.width/2,g.height/2),c.Cocoon.Utils.setAntialias(!1),g.ctx.imageSmoothingEnabled=!1,b.exports=g}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"../geom/dimension.js":23,"../geom/point.js":24,"../geom/rectangle.js":26,"../util/detect-mobile.js":48}],33:[function(a,b,c){function d(a){return a.charCode||a.keyCode||a.which}var e={alt:!1,ctrl:!1,shift:!1},f={};document.onkeydown=function(a){var b=d(a),c=String.fromCharCode(b);f[b]=!0,e[c]=!0,e.alt=a.altKey,e.ctrl=a.ctrlKey,e.shift=a.shiftKey},document.onkeyup=function(a){var b=d(a),c=String.fromCharCode(b);f[b]=!1,e[c]=!1,e.alt=a.altKey,e.ctrl=a.ctrlKey,e.shift=a.shiftKey},b.exports={get alt(){return e.alt},get ctrl(){return e.ctrl},get shift(){return e.shift},arrow:{get left(){return f[37]||!1},get up(){return f[38]||!1},get right(){return f[39]||!1},get down(){return f[40]||!1}},name:function(a){return e[a]||!1},code:function(a){return f[a]||!1}}},{}],34:[function(a,b,c){(function(c){function d(a){i?(l.x=a.touches[0].clientX,l.y=a.touches[0].clientY):(l.x=a.offsetX,l.y=a.offsetY)}var e=a("../eventable.js"),f=a("../geom/point.js"),g=a("../geom/vector.js"),h=a("./canvas.js"),i=a("../util/detect-mobile.js"),j=null,k={down:!1,up:!0,dragging:!1,holding:!1},l=f(),m=f(),n=g(),o=i?"touchstart":"mousedown",p=i?"touchmove":"mousemove",q=i?"touchend":"mouseup";h.addEventListener(o,function(a){k.down=k.holding=!0,k.up=!1,d(a),b.exports.trigger("$down",l)}),c.document.addEventListener(q,function(){k.down=k.dragging=k.holding=!1,k.up=!0,j=null,b.exports.trigger("$up",l)}),h.addEventListener(p,function(a){m.x=l.x,m.y=l.y,d(a),k.down&&(k.holding=!1,k.dragging||(n.x=l.x-m.x,n.y=l.y-m.y,n.D()>1&&(k.dragging=!0,j=l)),k.dragging&&b.exports.trigger("$drag",l))}),b.exports=e().extend({is:k,offset:l,dragStart:j,eventName:{start:o,move:p,end:q}})}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"../eventable.js":21,"../geom/point.js":24,"../geom/vector.js":28,"../util/detect-mobile.js":48,"./canvas.js":32}],35:[function(a,b,c){var d=a("baseclassjs"),e=a("./eventable.js");b.exports=function(a){return a=a||{},e(a).extend({name:a.name||"$:item",kind:a.kind||"$:item",depth:a.depth||0,removed:!1,updating:"updating"in a?a.updating:!0,drawing:"drawing"in a?a.drawing:!0,update:d.Stub,draw:d.Stub,teardown:d.Stub,start:function(){this.updating=!0,this.drawing=!0,this.trigger("$start")},pause:function(){this.updating=!1,this.drawing=!0,this.trigger("$pause")},stop:function(){this.updating=!1,this.drawing=!1,this.trigger("$stop")}})}},{"./eventable.js":21,baseclassjs:4}],36:[function(a,b,c){var d=a("../collidable.js"),e=a("../geom/point.js"),f=a("../geom/vector.js"),g=a("../io/mouse.js"),h=a("../dragon-collisions.js"),i=a("../geom/rectangle.js"),j=!1,k=e(-999,-999);b.exports=d({name:"screendrag",mask:i(k.x,k.y,12,12),collisions:h,offset:f(-6,-6)}).extend({update:function(){g.is.dragging?(j=!1,this.move(g.offset)):j||(j=!0,this.move(k)),this.base.update()}})},{"../collidable.js":16,"../dragon-collisions.js":19,"../geom/point.js":24,"../geom/rectangle.js":26,"../geom/vector.js":28,"../io/mouse.js":34}],37:[function(a,b,c){var d=a("../collidable.js"),e=a("../geom/point.js"),f=a("../geom/vector.js"),g=a("../io/mouse.js"),h=a("../dragon-collisions.js"),i=a("../geom/rectangle.js"),j=!1,k=e(-999,-999);b.exports=d({name:"screenhold",mask:i(k.x,k.y,12,12),collisions:h,offset:f(-6,-6)}).extend({update:function(){g.is.down&&!g.is.dragging?(j=!1,this.move(g.offset)):j||(j=!0,this.move(k)),this.base.update()}})},{"../collidable.js":16,"../dragon-collisions.js":19,"../geom/point.js":24,"../geom/rectangle.js":26,"../geom/vector.js":28,"../io/mouse.js":34}],38:[function(a,b,c){var d=a("../collidable.js"),e=a("../geom/point.js"),f=a("../geom/vector.js"),g=a("../io/mouse.js"),h=a("../dragon-collisions.js"),i=a("../geom/rectangle.js"),j=!1,k=!1,l=e(-999,-999);b.exports=d({name:"screentap",mask:i(l.x,l.y,12,12),collisions:h,offset:f(-6,-6)}).extend({update:function(){j&&!k?(k=!0,this.move(l)):!j&&g.is.down?(j=!0,k=!1,this.move(g.offset)):j&&g.is.up&&(j=!1),this.base.update()}})},{"../collidable.js":16,"../dragon-collisions.js":19,"../geom/point.js":24,"../geom/rectangle.js":26,"../geom/vector.js":28,"../io/mouse.js":34}],39:[function(a,b,c){var d=a("baseclassjs"),e=a("../clear-sprite.js"),f=a("../geom/vector.js"),g=a("../geom/dimension.js"),h=a("../util/random.js"),i=a("../util/timer.js");b.exports=function(a){var b,c,j=!1;return a=a||{},a.name=a.name||"$:particle",a.kind=a.kind||"$:particle",a.size=a.size||g(4,4),a.rotationSpeed=a.rotationSpeed||.4*h()-.2,a.speed=a.speed||f(h()-.5,h()-.5),c=a.speed.clone(),a.lifespan=a.lifespan||1e3,a.lifespan+=250*h(),a.style=a.style||d.Stub,a.fade=a.fade||.05,e(a).extend({_create:function(){this.stop()},reset:function(d){this.stop(),i.clear(b),j=!1,this.alpha=1,this.rotation=0,this.rotationSpeed=a.rotationSpeed,this.move(d),this.speed.set(c)},start:function(){this.base.start(),b=i.setTimeout(function(){j=!0},a.lifespan)},update:function(){j&&(this.alpha-=a.fade),this.alpha<0&&a.owner.reclaim(this),this.base.update()},draw:function(b){this.base.draw(b),a.style(b)}})}},{"../clear-sprite.js":14,"../geom/dimension.js":23,"../geom/vector.js":28,"../util/random.js":53,"../util/timer.js":55,baseclassjs:4}],40:[function(a,b,c){var d=a("./base.js"),e=a("../util/number.js");b.exports=function(a){return a=a||{},a.name=a.name||"$:particle-circle",a.rotationSpeed=0,d(a).extend({draw:function(a){this.base.draw(a),a.beginPath(),a.arc(0,0,this.size().width/2,0,e.PI2),a.fill()}})}},{"../util/number.js":51,"./base.js":39}],41:[function(a,b,c){var d=a("baseclassjs"),e=a("../collection.js"),f=a("../geom/point.js"),g=(a("../io/canvas.js"),a("../util/timer.js"));b.exports=function(a){var b,c=[],h=[];return a.name=a.name||"$:emitter",a.kind=a.kind||"$:emitter",a.pos=a.pos||f(),a.speed=a.speed||250,a.volume=a.volume||4,a.style=a.style||d.Stub,a.conf=a.conf||d.Stub,e(a).extend({sorted:!1,speed:a.speed,volume:a.volume,_create:function(){var d,e,f;for(d=0;50>d;d+=1)f=a.conf()||{},f.owner=this,f.pos=f.pos||a.pos.clone(),e=a.type(f),c.push(e),this.set.push(e);this.speed&&(b=g.setInterval(function(){this.fire()},this.speed,this))},fire:function(){var a,b;for(h=c.splice(0,this.volume),b=h.length,a=0;b>a;a+=1)h[a].start()},draw:function(b){a.style.call(this,b),this.base.draw(b)},kill:function(){g.clear(b)},reclaim:function(a){a.reset(this.pos),c.push(a)},pos:a.pos,move:function(a){var b,c=this.set.length;for(this.pos=a,b=0;c>b;b+=1)this.set[b].reset(a)},teardown:function(){}})}},{"../collection.js":15,"../geom/point.js":24,"../io/canvas.js":32,"../util/timer.js":55,baseclassjs:4}],42:[function(a,b,c){var d=a("./base.js"),e=a("../assets/pipeline.js");b.exports=function(a){var b=e.get.image(a.src);return a.name=a.name||"$:particle-image",d(a).extend({draw:function(a){this.base.draw(a),a.drawImage(b,-this.size().width/2,-this.size().height/2,this.size().width,this.size().height)}})}},{"../assets/pipeline.js":13,"./base.js":39}],43:[function(a,b,c){var d=a("./base.js");b.exports=function(a){return a=a||{},a.name=a.name||"$:particle-square",d(a).extend({draw:function(a){this.base.draw(a),a.beginPath(),a.rect(-this.size().width/2,-this.size().height/2,this.size().width,this.size().height),a.fill()}})}},{"./base.js":39}],44:[function(a,b,c){var d=a("./collection.js"),e=a("./game.js").debug;b.exports=function(a){var b=d({name:"$:screen-collisions",sorted:!1}).add(a.collisions);return a.name=a.name||"$.screen",a.kind=a.kind||"$.screen",a.updating=a.updating||!1,a.drawing=a.drawing||!1,d(a).extend({_create:function(){this.add(a.sprites)},start:function(){b.start(),this.base.start()},pause:function(){b.pause(),this.base.pause()},stop:function(){b.stop(),this.base.stop()},addCollisions:b.add,sprite:function(a){return this.base.get(a)},addSprites:function(a){this.base.add(a)},removeSprite:function(a){this.base.remove(a)},clearSprites:function(){this.base.clear()},update:function(){var a,c=b.set.length;for(this.base.update(),a=0;c>a;a+=1)b.set[a].handleCollisions()},draw:function(a){this.base.draw(a),e&&b.draw(a)},teardown:function(){this.base.teardown(),b.teardown()}})}},{"./collection.js":15,"./game.js":22}],45:[function(a,b,c){(function(c){var d=a("./clear-sprite.js"),e=(a("./geom/dimension.js"),a("./animation-strip.js"));a("./util/object.js");b.exports=function(a){var b,f,g=a.strips||{};"string"==typeof g&&(g={strip:g});for(b in g)f=g[b],"string"==typeof f&&(g[b]=e(f));return a.name=a.name||"$:sprite",a.kind=a.kind||"$.sprite",a.startingStrip=a.startingStrip||c.Object.keys(g)[0],a.size=a.size||(g[a.startingStrip]||{}).size,d(a).extend({strip:g[a.startingStrip],useStrip:function(a){this.strip!==g[a]&&(this.strip.stop(),this.strip=g[a],this.strip.start())},getStrip:function(a){return g[a]},start:function(){this.base.start(),this.strip.start()},pause:function(){this.base.pause(),this.strip.pause()},stop:function(){this.base.stop(),this.strip.stop()},update:function(){this.strip.updating&&this.strip.update(),this.base.update()},draw:function(a){this.base.draw(a),this.strip.draw(a,this.size())}})}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./animation-strip.js":9,"./clear-sprite.js":14,"./geom/dimension.js":23,"./util/object.js":52}],46:[function(a,b,c){var d=a("baseclassjs"),e=a("../sprite.js"),f=a("../util/set.js"),g=a("../dragon-collisions.js");b.exports=function(a){return a=a||{},a.down=a.down||a.up,a.name=a.name||"$:ui-button",a.kind=a.kind||"$:ui-button",a.startingStrip=a.startingStrip||"up",a.onpress=a.onpress||d.Stub,a.collisions=f.concatLeft(a.collisions,g),a.on=a.on||{},a.on["$collide#screentap"]=f.concat(a.on["$collide#screentap"],function(){this.auto&&this.useStrip("down"),a.onpress.call(this)}),a.on["$miss#screenhold"]=f.concat(a.on["$miss#screenhold"],function(){this.auto&&this.useStrip("up")}),e(a).extend({auto:a.auto||!0})}},{"../dragon-collisions.js":19,"../sprite.js":45,"../util/set.js":54,baseclassjs:4}],47:[function(a,b,c){var d=a("baseclassjs"),e=a("../clear-sprite.js");b.exports=function(a){return a=a||{},a.name=a.name||"$:ui-label",a.kind=a.kind||"$:ui-label",a.text=a.text||"",a.style=a.style||d.Stub,e(a).extend({text:a.text,draw:function(b){a.style(b),b.fillText(this.text,this.pos.x,this.pos.y)}})}},{"../clear-sprite.js":14,baseclassjs:4}],48:[function(a,b,c){b.exports="ontouchstart"in window},{}],49:[function(a,b,c){(function(c){function d(a){var b=1e3+a;h=c.Math.floor(frameCount/b*1e3),frameCount=0,j.push(h),j.length>10&&j.shift(),meantot=j.reduce(function(a,b){return a+b}),i=(meantot/j.length).toFixed(1)}var e,f=a("./timer.js"),g=!1,h=frameCount=0,i=meantot=0,j=[];b.exports={countFrame:function(){frameCount+=1},get frameRate(){return h},kill:function(){g&&f.clear(e)},draw:function(a){a.resetTransform(),a.globalAlpha=.5,a.font="30px Verdana",a.fillStyle="#f55",a.textBaseline="top",a.textAlign="left",a.fillText(h+"/"+i,20,20)},start:function(){g||(e=f.setInterval(d,1e3))}}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./timer.js":55}],50:[function(a,b,c){var d=0;b.exports={lastId:function(){return d},nextId:function(){return d+=1}}},{}],51:[function(a,b,c){(function(a){var c,d,e={},f={};for(c=6.28;c>=-6.28;c-=.01)d=c.toFixed(2),e[d]=a.Math.sin(c),f[d]=a.Math.cos(c);e["-0.00"]=e["0.00"],f["-0.00"]=f["0.00"],b.exports={PI:3.14159,PI2:6.28318,sin:function(a){var b;return a%=this.PI2,b=a.toFixed(2),e[b]},cos:function(a){var b;return a%=this.PI2,b=a.toFixed(2),f[b]}}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],52:[function(a,b,c){(function(a){b.exports={cloneArray:function(a){var b,c=a.length,d=[];for(b=0;c>b;b+=1)d.push(this.clone(a[b]));return d},cloneObject:function(a){var b,c={};if("clone"in a&&"function"==typeof a.clone)return a.clone();for(b in a)c[b]=this.clone(a[b]);return c},clone:function(b){return b instanceof a.Array?this.cloneArray(b):"object"==typeof b?this.cloneObject(b):b},mergeLeft:function(a,b,c){var d,e;a=a||{},b=b||{},e=c?this.clone(a):a;for(d in b)a[d]=b[d];return a},mergeDefaults:function(a,b,c){var d,e;a=a||{},b=b||{},e=c?this.clone(a):a;for(d in b)d in e&&"undefined"!=typeof e[d]||(e[d]=b[d]);return e}}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],53:[function(a,b,c){(function(a){var c,d=200,e=[],f=0;for(c=0;d>c;c+=1)e.push(a.Math.random());b.exports=function(){return f+=1,f%=d,e[f]}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],54:[function(a,b,c){var d=a("./random.js");b.exports={shuffle:function(a){var b,c,e;for(b=0;b<a.length;b+=1)c=parseInt(d()*(b+1)),e=a[b],a[b]=a[c],a[c]=e;return a},range:function(a,b){var c,d,e=[];for(b||(b=a,a=0),d=b-a,c=0;d>c;c+=1)e.push(c+a);return e},concatLeft:function(){var a,b,c,d=arguments.length;for(arguments[0]&&arguments[0].push?(c=arguments[0],a=1):(c=[],a=0),a;d>a;a+=1)b=arguments[a],(b||0===b||""===b)&&(b.push?c.push.apply(c,b):c.push(b));return c},concat:function(){var a,b,c=arguments.length,d=[];for(a=0;c>a;a+=1)b=arguments[a],(b||0===b||""===b)&&(b.push?d.push.apply(d,b):d.push(b));return d},array:function(a){return a?a.push?a:[a]:[]}}},{"./random.js":53}],55:[function(a,b,c){(function(c){var d=a("./id-counter.js"),e=c.Date.now(),f={},g=[],h=[],i=[],j=[];b.exports={update:function(){var a,b,d,k=c.Date.now(),l=k-e;for(d=g.length,a=0;d>a;a+=1)b=g[a],b.id in f?(g.splice(a,1),a-=1,d-=1):(b.life-=l,b.life<=0&&(b.event.call(b.thisArg,-b.life),f[b.id]=!0));for(g.push.apply(g,h),h.length=0,d=i.length,a=0;d>a;a+=1)b=i[a],b.id in f?(i.splice(a,1),a-=1,d-=1):(b.life-=l,b.life<=0&&(b.event.call(b.thisArg,-b.life),b.life=b.delay));i.push.apply(i,j),j.length=0,e=k},setTimeout:function(a,b,c){var e=d.nextId();return h.push({event:a,thisArg:c,life:b,id:e}),e},setInterval:function(a,b,c){var e=d.nextId();return j.push({event:a,thisArg:c,life:b,delay:b,id:e}),e},clear:function(a){
f[a]=!0}}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./id-counter.js":50}],56:[function(a,b,c){var d=a("dragonjs");b.exports=d.CollisionHandler({name:"racetrack"})},{dragonjs:18}],57:[function(a,b,c){b.exports=[{name:"Clydesdale Clive",body:325},{name:"Arabian Andy",body:423},{name:"Mustang Mike",body:154},{name:"Ronny Roan",body:254}]},{}],58:[function(a,b,c){var d=a("dragonjs");d.addFont("Wonder",{src:"8-bit-wonder.TTF"}),d.loadAssets(function(){d.debug(),d.addScreens([a("./screens/gear.js"),a("./screens/train.js"),a("./screens/care.js")])})},{"./screens/care.js":65,"./screens/gear.js":66,"./screens/train.js":71,dragonjs:18}],59:[function(a,b,c){function d(a){var b=[1,1.2,1.4,1.6,1.8],c=.1*e.random();return b[a]+c}var e=a("dragonjs"),f=a("./sprites/horse.js"),g=a("./picker.js"),h=a("./stats/horse.js");b.exports=function(a){var b=g.next.horse;return f({name:b.name,stats:h({body:b.body*d(a)})})}},{"./picker.js":63,"./sprites/horse.js":79,"./stats/horse.js":93,dragonjs:18}],60:[function(a,b,c){b.exports={none:function(){},flu:function(a){a.speed*=.8,a.jump*=.8,a.strength*=.8},thrush:function(a){a.speed*=.2},tetanus:function(){},rainRot:function(){},swampFever:function(){}}},{}],61:[function(a,b,c){var d=a("dragonjs"),e=a("./sprites/track/lane.js"),f=a("./sprites/track/items/haybale.js"),g=a("./sprites/track/items/mudpit.js"),h=a("./player.js"),i=a("./horse-factory.js"),j={none:0,low:4,medium:8,high:12};b.exports=function(a,b){var c,k=j[b.density],l=d.random()*j[b.density]/2,m=[],n=a?i(a-1):h.horse;for(k+=l,k=1,c=0;k>c;c+=1)m.push(f({horse:n,position:.3})),m.push(g({horse:n,position:.5}));return function(a){return e({horse:n,order:a,items:m})}}},{"./horse-factory.js":59,"./player.js":64,"./sprites/track/items/haybale.js":85,"./sprites/track/items/mudpit.js":87,"./sprites/track/lane.js":88,dragonjs:18}],62:[function(a,b,c){var d=a("dragonjs");b.exports=function(a){return d.shuffle(d.range(a))}},{dragonjs:18}],63:[function(a,b,c){(function(c){var d=a("dragonjs"),e=a("./data/horses.json");b.exports={next:{get horse(){var a=c.Math.floor(d.random()*e.length);return e[a]},get jockey(){return"jimmy"}}}}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./data/horses.json":57,dragonjs:18}],64:[function(a,b,c){var d=a("./sprites/horse.js"),e=a("./sprites/jockey.js");b.exports={money:100,stats:a("./shop-stats.js"),horse:d().extend({name:"player"}),jockey:e()}},{"./shop-stats.js":72,"./sprites/horse.js":79,"./sprites/jockey.js":80}],65:[function(a,b,c){var d=a("dragonjs");b.exports=d.Screen({name:"care",sprites:[a("../sprites/buttons/open-gear.js"),a("../sprites/buttons/open-train.js"),a("../sprites/buttons/open-care.js"),a("../sprites/buttons/race.js")],depth:0}).extend({draw:function(a){d.canvas.clear("#fde142"),this.base.draw(a)}})},{"../sprites/buttons/open-care.js":74,"../sprites/buttons/open-gear.js":75,"../sprites/buttons/open-train.js":76,"../sprites/buttons/race.js":77,dragonjs:18}],66:[function(a,b,c){var d=a("dragonjs");b.exports=d.Screen({name:"gear",sprites:[a("../sprites/buttons/open-gear.js"),a("../sprites/buttons/open-train.js"),a("../sprites/buttons/open-care.js"),a("../sprites/buttons/race.js")],depth:0}).extend({draw:function(a){d.canvas.clear("#fde142"),this.base.draw(a)}})},{"../sprites/buttons/open-care.js":74,"../sprites/buttons/open-gear.js":75,"../sprites/buttons/open-train.js":76,"../sprites/buttons/race.js":77,dragonjs:18}],67:[function(a,b,c){var d=a("dragonjs"),e=a("../sprites/track/raceresult.js");b.exports=d.Screen({name:"raceresult",sprites:[e.win,e.lose],depth:10}).extend({start:function(a){a?e.win.start():e.lose.start(),this.base.start()},stop:function(){e.win.stop(),e.lose.stop(),this.base.stop()}})},{"../sprites/track/raceresult.js":90,dragonjs:18}],68:[function(a,b,c){var d=a("dragonjs"),e=a("../sprites/track/countdown.js");b.exports=d.Screen({name:"startrace",sprites:e,depth:10,on:{$added:function(){this.start()}}}).extend({start:function(){function a(b){return function(){b>0?(e.text=b,d.setTimeout(a(b-1),1e3)):(e.text="and they're off!",d.setTimeout(function(){d.screen("startrace").stop(),d.removeScreen("startrace")},1e3),d.screen("track").race())}}a(1)(),this.base.start()}})},{"../sprites/track/countdown.js":84,dragonjs:18}],69:[function(a,b,c){var d=a("dragonjs"),e=a("../player.js"),f=a("../lane-ordering.js");b.exports=function(b){var c,g,h,i=[],j=[],k=b.laneFactories.length,l=f(k);for(h=0;k>h;h+=1)g=b.laneFactories[h],c=g(l[h]),j.push(c),d.concatLeft(i,c.getSprites());return d.Screen({name:"track",collisions:a("../collisions/racetrack.js"),sprites:d.concat(j,i),depth:0,on:{$added:function(){d.addScreens([a("./startrace.js"),a("./raceresult.js")]),this.start()}}}).extend({trackLength:0,race:function(){var a,b=j.length;for(a=0;b>a;a+=1)j[a].race(this.trackLength)},endRace:function(a,b){var c,f=j.length;for(c=0;f>c;c+=1)j[c].pause();d.screen("raceresult").start(a),d.setTimeout(function(){e.horse.endRace(),d.screen("raceresult").stop(),d.removeScreen("raceresult"),d.removeScreen("track"),d.screen("train").start()},2e3),this.pause()},draw:function(a){d.canvas.clear("#67fb04"),this.base.draw(a)}})}},{"../collisions/racetrack.js":56,"../lane-ordering.js":62,"../player.js":64,"./raceresult.js":67,"./startrace.js":68,dragonjs:18}],70:[function(a,b,c){var d=a("../track.js"),e=a("../../lane-factory.js");b.exports=function(){var a={density:"low",terrain:"dirt",weather:"comfy",type:"rural"};return d({laneFactories:[e(!1,a),e(2,a),e(1,a),e(1,a),e(1,a)]}).extend({trackLength:3e3})}},{"../../lane-factory.js":61,"../track.js":69}],71:[function(a,b,c){(function(c){var d=a("dragonjs"),e=a("../sprites/buttons/open-train.js"),f=a("../player.js"),g=a("../sprites/shop/train-label.js"),h=a("../sprites/shop/stat-label.js"),i=a("../sprites/buttons/add-rank.js"),j=a("../shop-stats.js");b.exports=d.Screen({name:"train",sprites:[a("../sprites/shop/ranks.js"),a("../sprites/buttons/open-gear.js"),e,a("../sprites/buttons/open-care.js"),a("../sprites/buttons/race.js"),i("gym",function(){f.jockey.stats.core.body+=1}),i("coach"),i("facility",function(){var a=[250,200,150,100,100],b=c.Math.floor(50*d.random()),e=a[j.facility-1]+b;f.horse.stats.core.body+=e}),i("groom"),i("doctor"),g("Gym"),g("Coach"),g("Facility"),g("Groom"),g("Doctor"),h("horse","body"),h("horse","mind"),h("horse","health"),h("jockey","body"),h("jockey","mind"),h("jockey","temper")],one:{$added:function(){this.start(),e.pause(),e.useStrip("down")}},depth:0}).extend({draw:function(a){d.canvas.clear("#fde142"),this.base.draw(a)}})}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"../player.js":64,"../shop-stats.js":72,"../sprites/buttons/add-rank.js":73,"../sprites/buttons/open-care.js":74,"../sprites/buttons/open-gear.js":75,"../sprites/buttons/open-train.js":76,"../sprites/buttons/race.js":77,"../sprites/shop/ranks.js":81,"../sprites/shop/stat-label.js":82,"../sprites/shop/train-label.js":83,dragonjs:18}],72:[function(a,b,c){var d={};b.exports={groom:d.groom||0,facility:d.facility||0,doctor:d.doctor||0,gym:d.gym||0,coach:d.coach||0}},{}],73:[function(a,b,c){var d=a("dragonjs"),e=.1*d.canvas.height,f=a("../../player.js"),g=a("../shop/ranks.js");b.exports=function(a,b){return b=b||function(){},d.ui.Button({pos:d.Point(g.skillpos[a].x+g.realWidth-e,g.skillpos[a].y-e-2),size:d.Dimension(e,e),strips:{up:"buttons/plus.png",down:"buttons/plus.null.png"},onpress:function(){f.stats[a]<5&&(f.stats[a]+=1,b()),f.stats[a]>=5&&(this.auto=!1,this.useStrip("down"))}})}},{"../../player.js":64,"../shop/ranks.js":81,dragonjs:18}],74:[function(a,b,c){var d=a("dragonjs"),e=.32*d.canvas.height,f=.1;b.exports=d.ui.Button({name:"open-care",strips:{up:"buttons/care.png",down:"buttons/care.down.png"},pos:d.Point(0,d.canvas.height-e),size:d.Dimension(d.canvas.width*f,e),onpress:function(){d.screen("train").stop(),d.screen("gear").stop(),d.screen("care").start(),this.pause(),a("./open-gear.js").start(),a("./open-train.js").start()}}).extend({width:f,realWidth:d.canvas.width*f})},{"./open-gear.js":75,"./open-train.js":76,dragonjs:18}],75:[function(a,b,c){var d=a("dragonjs");b.exports=d.ui.Button({name:"open-gear",pos:d.Point(0,0),size:d.Dimension(.1*d.canvas.width,.32*d.canvas.height),strips:{up:"buttons/gear.png",down:"buttons/gear.down.png"},onpress:function(){d.screen("train").stop(),d.screen("care").stop(),d.screen("gear").start(),this.pause(),a("./open-train.js").start(),a("./open-care.js").start()}})},{"./open-care.js":74,"./open-train.js":76,dragonjs:18}],76:[function(a,b,c){var d=a("dragonjs");b.exports=d.ui.Button({name:"open-train",pos:d.Point(0,.32*d.canvas.height),size:d.Dimension(.1*d.canvas.width,.36*d.canvas.height),strips:{up:"buttons/train.png",down:"buttons/train.down.png"},onpress:function(){d.screen("gear").stop(),d.screen("care").stop(),d.screen("train").start(),this.pause(),a("./open-gear.js").start(),a("./open-care.js").start()}})},{"./open-care.js":74,"./open-gear.js":75,dragonjs:18}],77:[function(a,b,c){var d=a("dragonjs"),e=a("../../screens/tracks/riverton.js"),f=.18;b.exports=d.ui.Button({pos:d.Point(d.canvas.width*(1-f),0),size:d.Dimension(d.canvas.width*f,d.canvas.height),strips:{up:"buttons/start-race.png",down:"buttons/start-race.down.png"},onpress:function(){d.screen("train").stop(),d.screen("gear").stop(),d.screen("care").stop(),d.addScreens(e())}}).extend({width:f,realWidth:d.canvas.width*f})},{"../../screens/tracks/riverton.js":70,dragonjs:18}],78:[function(a,b,c){var d=a("dragonjs");b.exports=function(){return d.particle.Emitter({name:"haybale-emitter",type:d.particle.Square,pos:d.Point(),volume:8,speed:0,style:function(a){0===this.damage?a.fillStyle="#eac644":1===this.damage?a.fillStyle="#7f6a00":a.fillStyle="#7f0000"},conf:function(){return{friction:.05,gravity:.1,speed:d.Vector(5*(d.random()-.5),5*-d.random())}}}).extend({damage:0})}},{dragonjs:18}],79:[function(a,b,c){var d=a("dragonjs"),e=a("../picker.js"),f=(a("../illness.js"),a("../stats/horse.js"));a("../shop-stats.js");b.exports=function(b){var c,g,h,i,j=.01,k=-1;return b=b||{},d.Sprite({gravity:.4,friction:j,name:b.name||e.next.horse.name,kind:"horse",depth:100,collisions:[a("../collisions/racetrack.js"),d.collisions],mask:d.Rectangle(),strips:"horse.png",scale:.5,on:{"$collide#screenedge/right":function(){this.speed.x=0,this.scale(2),this.rotation=0,this.pos.x=d.canvas.width/2-this.size().width/2,this.pos.y=d.canvas.height/2-this.size().height/2,d.screen("track").endRace(this===a("../player.js").horse,this)}}}).extend({stats:f(),resetFriction:function(){this.friction=j},endRace:function(){this.racing=!1,this.scale(.5),this.rotation=0},race:function(a){c=this.pos.y,h=.08*d.random(),g=10*d.random()+2,this.speed.x=i=this.stats.adj.body/a},jump:function(){this.speed.y=-(1.5*d.random()+3),k*=-1,this.rotation=.1*k*(1+d.random()),g-=1,-8>g?(g=10*d.random()+2,this.speed.x=2.5*i):0>g&&(this.speed.x=i)}})}},{"../collisions/racetrack.js":56,"../illness.js":60,"../picker.js":63,"../player.js":64,"../shop-stats.js":72,"../stats/horse.js":93,dragonjs:18}],80:[function(a,b,c){var d=a("dragonjs"),e=a("../picker.js"),f=a("../stats/jockey.js");b.exports=function(a){return a=a||{},d.Sprite({name:a.name||e.next.jockey.name,kind:"jockey",strips:{jockey:"jockey.png"},size:d.Dimension(64,64),pos:d.Point(100,100),depth:2}).extend({stats:f()})}},{"../picker.js":63,"../stats/jockey.js":95,dragonjs:18}],81:[function(a,b,c){var d=a("dragonjs"),e=a("../../shop-stats.js"),f=a("../buttons/race.js"),g=a("../buttons/open-care.js"),h=d.canvas.width,i=d.canvas.height,j=(h-f.realWidth-g.realWidth)/2+g.realWidth,k=.3*h,l=.02*h;b.exports=d.Sprite({name:"skillrank-master",strips:{strip:d.AnimationStrip("icons/train-pips.png",{frames:6})}}).extend({skillpos:{facility:d.Point(j-l-k,.5*i),groom:d.Point(j-l-k,.7*i),doctor:d.Point(j-l-k,.9*i),gym:d.Point(j+l,.5*i),coach:d.Point(j+l,.7*i)},realWidth:k,realHeight:12,update:function(){},draw:function(a){var b;for(b in e)this.strip.frame=e[b],this.move(this.skillpos[b]),this.base.base.draw(a),this.strip.draw(a,d.Dimension(k,8))}})},{"../../shop-stats.js":72,"../buttons/open-care.js":74,"../buttons/race.js":77,dragonjs:18}],82:[function(a,b,c){var d=a("dragonjs"),e=a("../../player.js"),f=a("../buttons/race.js"),g=a("../buttons/open-care.js"),h=d.canvas.width,i=d.canvas.height,j=((h-f.realWidth-g.realWidth)/2+g.realWidth,.01*h),k={horse:{body:{name:"Body",pos:d.Point(g.realWidth+j,.1*i),side:"left"},mind:{name:"Mind",pos:d.Point(g.realWidth+j,.2*i),side:"left"},health:{name:"Health",pos:d.Point(g.realWidth+j,.3*i),side:"left"}},jockey:{body:{name:"Body",pos:d.Point(f.pos.x-j,.1*i),side:"right"},mind:{name:"Mind",pos:d.Point(f.pos.x-j,.2*i),side:"right"},temper:{name:"Temper",pos:d.Point(f.pos.x-j,.3*i),side:"right"}}};b.exports=function(a,b){return d.ui.Label({text:k[a][b].name+" "+e[a].stats.adj[b],pos:k[a][b].pos,style:function(c){c.font="12px Wonder",c.textBaseline="bottom",c.textAlign=k[a][b].side,c.fillStyle="black"}}).extend({update:function(){this.text=k[a][b].name+" "+e[a].stats.adj[b]}})}},{"../../player.js":64,"../buttons/open-care.js":74,"../buttons/race.js":77,dragonjs:18}],83:[function(a,b,c){var d=a("dragonjs"),e=.1*d.canvas.height,f=a("./ranks.js");b.exports=function(a){var b=a.toLowerCase();return d.ui.Label({text:a,pos:d.Point(f.skillpos[b].x+f.realWidth-e,f.skillpos[b].y-5),style:function(a){a.font="16px Wonder",a.textBaseline="bottom",a.textAlign="right",a.fillStyle="black"}})}},{"./ranks.js":81,dragonjs:18}],84:[function(a,b,c){var d=a("dragonjs");b.exports=d.ui.Label({name:"countdown",text:"-99",pos:d.Point(d.canvas.width/2,d.canvas.height/2),style:function(a){a.font="16px Wonder",a.textBaseline="middle",a.textAlign="center",a.fillStyle="black"}})},{dragonjs:18}],85:[function(a,b,c){var d=a("dragonjs"),e=a("./lane-item.js");a("../../effects/haybale-emitter.js");b.exports=function(a){return e({strips:{normal:d.AnimationStrip("haybale.png",{frames:3})},on:{"$colliding.horse":function(b){b===a.horse&&(b.flush(this),b.jump(),this.shrink())}},size:d.Dimension(10,10),mask:d.Rectangle()}).extend({lanePos:a.position,move:function(a){this.base.move(a)},update:function(){this.base.update()},draw:function(a){this.base.draw(a)},shrink:function(){this.mask.resizeFixed(this.mask.width,.91*this.mask.height),this.mask.moveFixed(this.mask.x,this.pos.y+this.size().height-this.mask.height)}})}},{"../../effects/haybale-emitter.js":78,"./lane-item.js":86,dragonjs:18}],86:[function(a,b,c){var d=a("dragonjs");b.exports=function(b){return b=b||{},b.kind=b.kind||"lane-item",b.depth=b.depth||2,b.collisions=d.concatLeft(b.collisions,a("../../../collisions/racetrack.js")),d.Sprite(b)}},{"../../../collisions/racetrack.js":56,dragonjs:18}],87:[function(a,b,c){var d=a("dragonjs"),e=a("./lane-item.js");b.exports=function(a){var b=.15;return e({mask:d.Rectangle(),strips:"mudpit.png",on:{"$collide.horse":function(c){c===a.horse&&(c.friction=b)},"$separate.horse":function(b){b===a.horse&&b.resetFriction()}},size:d.Dimension(10,3)}).extend({lanePos:a.position})}},{"./lane-item.js":86,dragonjs:18}],88:[function(a,b,c){var d=a("dragonjs"),e=a("./lanename.js");b.exports=function(b){var c,f,g=b.items||[],h=g.length,i=b.horse,j=b.order,k=50*j+40,l=d.canvas.height/20,m=e({name:j+1,longname:i.name,pos:d.Point(2,k)});for(i.pause(),i.moveFixed(20,k),f=0;h>f;f+=1)c=g[f],c.moveFixed(c.lanePos*d.canvas.width,k+l-c.size().height);return d.Sprite({kind:"lane",strips:"lane.png",size:d.Dimension(d.canvas.width,l),collisions:a("../../collisions/racetrack.js"),mask:d.Rectangle(0,l,d.canvas.width,10),pos:d.Point(0,k),depth:1,on:{"$colliding.horse":function(a){a===i&&i.jump()}}}).extend({getSprites:function(){return d.concat(g,m,i)},update:function(){var a,b=g.length;for(a=0;b>a;a+=1);this.base.update()},pause:function(){i.pause(),m.pause(),this.base.pause()},race:function(a){i.start(),i.race(a)}})}},{"../../collisions/racetrack.js":56,"./lanename.js":89,dragonjs:18}],89:[function(a,b,c){var d=a("dragonjs");b.exports=function(a){return d.ui.Label({text:a.name,depth:10,pos:a.pos,size:d.Dimension(15,15),style:function(a){a.font="12px Wonder",a.textBaseline="top",a.textAlign="left",a.fillStyle="black"},collisions:[d.collisions],mask:d.Rectangle(),on:{"$collide#screenhold":function(){this.text=a.longname},"$separate#screenhold":function(){this.text=a.name}}})}},{dragonjs:18}],90:[function(a,b,c){var d=a("dragonjs");b.exports={win:d.Sprite({name:"raceresult-win",strips:"win.png",updating:!1,drawing:!1,scale:3,pos:d.Point(d.canvas.width/2-75,d.canvas.height/2-12)}),lose:d.Sprite({name:"raceresult-lose",strips:"lost.png",updating:!1,drawing:!1,scale:3,pos:d.Point(d.canvas.width/2-84,d.canvas.height/2-12)})}},{dragonjs:18}],91:[function(a,b,c){b.exports=function(a){var b={},c={core:null,adj:null,reset:function(){c.adj=c.core.clone(),b={}},refresh:function(){var a,d;c.adj=c.core.clone();for(a in b)d=b[a],d&&(adj=d(adj))},modifier:{add:function(a,d){b[a]=d,c.refresh()},remove:function(a){b[a]=!1,c.refresh()}}};return c.core=a(c.refresh),c.adj=a(c.refresh),c}},{}],92:[function(a,b,c){b.exports=function(a){var c;return a=a||{},c={body:a.body||500,mind:a.mind||1,health:a.health||1},function(a){return{get body(){return c.body},set body(b){c.body=b,a()},get mind(){return c.mind},set mind(b){c.mind=b,a()},get health(){return c.health},set health(b){c.health=b,a()},clone:function(){return b.exports(this)(a)}}}}},{}],93:[function(a,b,c){var d=a("./horse.core.js"),e=a("./group.js");b.exports=function(a){return e(d(a))}},{"./group.js":91,"./horse.core.js":92}],94:[function(a,b,c){b.exports=function(a){var c;return a=a||{},c={body:a.body||120,mind:a.mind||1,temper:a.temper||1},function(a){return{get body(){return c.body},set body(b){c.body=b,a()},get mind(){return c.mind},set mind(b){c.mind=b,a()},get temper(){return c.health},set temper(b){c.temper=b,a()},clone:function(){return b.exports(this)(a)}}}}},{}],95:[function(a,b,c){var d=a("./jockey.core.js"),e=a("./group.js");b.exports=function(a){return e(d(a))}},{"./group.js":91,"./jockey.core.js":94}]},{},[58]);